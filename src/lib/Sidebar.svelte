<script>
  ...
  const menus = [
    { icon: "/assets/profile.svg", title: "Profile", key: "profile", type: "image" },
    { icon: "/assets/fleetview.svg", title: "Fleet View", key: "fleet-view", type: "image" },
    { icon: "/assets/vessel.svg", title: "Vessel", key: "vessel", type: "image" },
    { icon: "▤", title: "All Vessel Summary", key: "all-vessel-summary", type: "text" },
    { icon: "🔔", title: "Alarm", key: "alarm", type: "text" },
    { icon: "⌁", title: "Voyage Plans", key: "voyage-plans", type: "text" }
  ];

  const itemHeight = 46;

  let activeIndex = $derived(
    menus.findIndex((menu) => menu.key === $activeMenu)
  );
...
<aside class:sidebar-open={mobileSidebarOpen} class="sidebar">
  ...
  <div class="side-item logout-button">
    ...
    <button type="button" class="logout-btn" onclick={openLogoutConfirm}>
      Logout
    </button>
  </div>
</aside>
