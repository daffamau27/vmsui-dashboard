...
<section class="vessel-shell">
  <header class="vessel-topbar">
        ...
        <div class="vessel-menu">
          {#each vessels as vessel}
            <button
              type="button"
              class="vessel-item"
              class:active-vessel={selectedVessel === vessel.name}
    ...
    {#if shouldMountPage("dashboard")}
        <section
        class="vessel-page"
        class:active-vessel-page={isPageActive("dashboard")}
        >
    ...
    {#if shouldMountPage("daily-report")}
        <section
        class="vessel-page"
        class:active-vessel-page={isPageActive("daily-report")}
        >
    ...
    {#if shouldMountPage("monthly-report")}
        <section
        class="vessel-page"
        class:active-vessel-page={isPageActive("monthly-report")}
        >
    ...
    {#if shouldMountPage("periodical-report")}
        <section
        class="vessel-page"
        class:active-vessel-page={isPageActive("periodical-report")}
        >
    ...
    {#if shouldMountPage("voyage-plan")}
        <section
        class="vessel-page"
        class:active-vessel-page={isPageActive("voyage-plan")}
        >
    ...
    {#if shouldMountPage("trace")}
        <section
        class="vessel-page"
        class:active-vessel-page={isPageActive("trace")}
        >
    ...
    {#if shouldMountPage("datalog")}
        <section
        class="vessel-page"
        class:active-vessel-page={isPageActive("datalog")}
        >
